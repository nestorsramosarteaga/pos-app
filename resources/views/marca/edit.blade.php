...
@section('title','messages.brands.edit')
...
<div class="container-fluid px-4">
    <h1 class="mt-4">{{ __('messages.brands.edit') }}</h1>
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">{{ __('messages.brands.edit') }}</li>
    </ol>
        ...
        <form action="{{ route('marcas.update',['marca'=>$marca]) }}" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="descripcion" id="descripcion" rows="3" class="form-control textarea-fixed">{{old('descripcion', $marca->caracteristica->descripcion)}}</textarea>
                    @error('descripcion')
                        <small class="text-danger">{{'*' . $message}}</small>
                    @enderror
                </div>
